  ...
  return (
    <Box h='100vh' w='100vw' overflow='hidden' sx={{ position: `relative` }}>
      <Center
        ...
        w='100vw'
        color='brand.500'
        sx={{ position: `absolute`, top: 0, left: 0, userSelect: 'none' }}
      >
        <SlayingMoloch />
        <VStack align='center' spacing='3rem' sx={{ zIndex: `2` }}>
          ...
          >
            Hark! Adventurers!
            <br /> Observe a new tool for slaying Moloch:
          </Heading>
          <Heading
            as='h1'
            size='3xl'
...
function SlayingMoloch() {
  return (
    ...
    >
      <img
        src='/raidBanner.png'
        alt='Adventurers Slaying Moloch'
        style={{ height: `150vh`, transform: `translateY(-15%)` }}
      />
    </Box>
  );
}
...
function EnterApp(props) {
  return (
    ...
    >
      <Heading sx={{ padding: '1.5ex', paddingTop: `1ex` }}>
        Obtain New Powers
      </Heading>
    </Box>
  );
